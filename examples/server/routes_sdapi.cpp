...
static enum sample_method_t get_sdapi_sample_method(std::string name) {
    ...
    static const std::unordered_map<std::string_view, sample_method_t> hardcoded{
        ...
        {"dpm++ sde", DPMPP_SDE_SAMPLE_METHOD},
        {"dpm++sde", DPMPP_SDE_SAMPLE_METHOD},
        {"dpmpp_sde", DPMPP_SDE_SAMPLE_METHOD},
        {"dpmpp_sde_gpu", DPMPP_SDE_GPU_SAMPLE_METHOD},
        {"k_dpmpp_sde", DPMPP_SDE_SAMPLE_METHOD},
        {"k_dpmpp_sde_gpu", DPMPP_SDE_GPU_SAMPLE_METHOD},
        {"dpm++ 2m sde", DPMPP2M_SDE_SAMPLE_METHOD},
        {"dpm++2m_sde", DPMPP2M_SDE_SAMPLE_METHOD},
        {"dpmpp_2m_sde", DPMPP2M_SDE_SAMPLE_METHOD},
        {"dpmpp_2m_sde_gpu", DPMPP2M_SDE_GPU_SAMPLE_METHOD},
        {"k_dpmpp_2m_sde", DPMPP2M_SDE_SAMPLE_METHOD},
        {"k_dpmpp_2m_sde_gpu", DPMPP2M_SDE_GPU_SAMPLE_METHOD},
        {"dpm++ 2m sde heun", DPMPP2M_SDE_HEUN_SAMPLE_METHOD},
        {"dpm++2m_sde_heun", DPMPP2M_SDE_HEUN_SAMPLE_METHOD},
        {"dpmpp_2m_sde_heun", DPMPP2M_SDE_HEUN_SAMPLE_METHOD},
        {"dpmpp_2m_sde_heun_gpu", DPMPP2M_SDE_HEUN_GPU_SAMPLE_METHOD},
        {"k_dpmpp_2m_sde_heun", DPMPP2M_SDE_HEUN_SAMPLE_METHOD},
        {"k_dpmpp_2m_sde_heun_gpu", DPMPP2M_SDE_HEUN_GPU_SAMPLE_METHOD},
        {"dpm++ 3m sde", DPMPP3M_SDE_SAMPLE_METHOD},
        {"dpm++3m_sde", DPMPP3M_SDE_SAMPLE_METHOD},
        {"dpmpp_3m_sde", DPMPP3M_SDE_SAMPLE_METHOD},
        {"dpmpp_3m_sde_gpu", DPMPP3M_SDE_GPU_SAMPLE_METHOD},
        {"k_dpmpp_3m_sde", DPMPP3M_SDE_SAMPLE_METHOD},
        {"k_dpmpp_3m_sde_gpu", DPMPP3M_SDE_GPU_SAMPLE_METHOD},
        ...
        {"er sde", ER_SDE_SAMPLE_METHOD},
        {"k_er_sde", ER_SDE_SAMPLE_METHOD},
    };
