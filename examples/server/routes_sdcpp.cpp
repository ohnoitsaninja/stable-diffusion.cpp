        ...
        {"sample_params",
         {
             ...
             {"s_noise", finite_number_or_null(sample_params.s_noise)},
             {"dpmpp_sde_r", finite_number_or_null(sample_params.dpmpp_sde_r)},
             {"dpmpp_sde_solver", sample_params.dpmpp_sde_solver == DPMPP_SDE_SOLVER_HEUN ? "heun" : "midpoint"},
